...
```text
Fan ON threshold:      85 ÅãC
Fan OFF threshold:     80 ÅãC

Warning ON threshold:  95 ÅãC
Warning OFF threshold: 90 ÅãC
```
...
| 220 É∂ resistor         | LED current limiting                         |
| 1 kÉ∂ resistor          | Transistor base-current limiting             |
...
LED resistor:          220 É∂
Base resistor:         1 kÉ∂
Ceramic capacitor:     104 = 0.1 ?F
Bulk capacitor:        220?1000 ?F
```
...
```text
Potentiometer terminal 1 Å® 5 V
Potentiometer center     Å® A0
Potentiometer terminal 3 Å® GND
```
...
```text
Vout = Vin Å~ Rbottom / (Rtop + Rbottom)
```
...
If the simulated maximum temperature is `120 ÅãC`:
...
```text
Base
Å® Receives the control current

Collector
Å® Carries the motor current

Emitter
Å® Returns current to ground
```
...
Å® Motor negative terminal / collector
```
...
Å® Diode becomes forward-biased
Å® Current circulates safely
```
...
```text
Capacitor positive Å® 5 V
Capacitor negative Å® GND
```
...
```text
External 5 V Å® Motor positive
Motor negative Å® Collector
Emitter Å® External GND
Arduino GND Å® External GND
D8 Å® Base resistor Å® Base
```
...
```text
Red probe  Å® Arduino 5 V
Black probe Å® Arduino GND
```
...
```text
Fan OFF Å® Approximately 0 V
Fan ON  Å® Near supply voltage
```
...
```text
Transistor OFF Å® Near supply voltage
Transistor ON  Å® Approximately 0.1?0.3 V
```
...
```text
CH1 Å® Arduino 5 V rail
CH2 Å® D8
Both ground clips Å® Arduino GND
```
...
```text
fan_cooling OFF Å® LED OFF
fan_cooling ON  Å® LED ON
```
...
```text
104 ceramic capacitor
Å® Across motor terminals

220?1000 ?F electrolytic capacitor
Å® Near motor supply input

0.1 ?F ceramic capacitor
Å® Near Arduino supply pins
```
...
```text
Long lead  Å® Positive
Short lead Å® Negative
Stripe with minus signs Å® Negative
```
