...
Embedded-Control-Architecture/
‚îú‚îÄ‚îÄ assembly/
‚î?   ‚îú‚îÄ‚îÄ instantiation.h
‚î?   ‚îî‚îÄ‚îÄ instantiation_practice.h
‚î?
‚îú‚îÄ‚îÄ docs/
‚î?   ‚îú‚îÄ‚îÄ circuit-notes.md
‚î?   ‚îî‚îÄ‚îÄ troubleshooting.md
‚î?
‚îú‚îÄ‚îÄ examples/
‚î?   ‚îú‚îÄ‚îÄ 
‚î?   ‚îî‚îÄ‚îÄ 
‚î?
‚îú‚îÄ‚îÄ framework/
‚î?   ‚îú‚îÄ‚îÄ manager.h
‚î?   ‚îî‚îÄ‚îÄ module_interface.h
‚î?
‚îú‚îÄ‚îÄ modules/
‚î?   ‚îú‚îÄ‚îÄ gear_display_facade/
‚î?   ‚î?   ‚îú‚îÄ‚îÄ include/
‚î?   ‚î?   ‚î?   ‚îú‚îÄ‚îÄ gear_display_facade.h
‚î?   ‚î?   ‚î?   ‚îî‚îÄ‚îÄ gear_types.h
‚î?   ‚î?   ‚îî‚îÄ‚îÄ src/
‚î?   ‚î?       ‚îî‚îÄ‚îÄ gear_display_facade.cc
‚î?   ‚îú‚îÄ‚îÄ hydraulic_oil_warning/
‚î?   ‚î?   ‚îú‚îÄ‚îÄ include/
‚î?   ‚î?   ‚î?   ‚îî‚îÄ‚îÄ hydraulic_oil_warning.h
‚î?   ‚î?   ‚îî‚îÄ‚îÄ src/
‚î?   ‚î?       ‚îî‚îÄ‚îÄ hydraulic_oil_warning.cc
‚î?   ‚îú‚îÄ‚îÄ instantiation_practice/
‚î?   ‚î?   ‚îú‚îÄ‚îÄ include/
‚î?   ‚î?   ‚î?   ‚îú‚îÄ‚îÄ instantiation_practice.h
‚î?   ‚î?   ‚î?   ‚îî‚îÄ‚îÄ speed_monitor.h
‚î?   ‚î?   ‚îî‚îÄ‚îÄ src/
‚î?   ‚îú‚îÄ‚îÄ wl_cooling_fan_control/
‚î?   ‚î?   ‚îú‚îÄ‚îÄ include/
‚î?   ‚î?   ‚î?   ‚îú‚îÄ‚îÄ wl_cooling_fan_control.h
‚î?   ‚î?   ‚î?   ‚îî‚îÄ‚îÄ wlCoolingFanControl.h
‚î?   ‚î?   ‚îî‚îÄ‚îÄ src/
‚î?   ‚î?       ‚îú‚îÄ‚îÄ wl_cooling_fan_control.cc
‚î?   ‚î?       ‚îî‚îÄ‚îÄ wlCoolingFanControl.cc
‚î?   ‚îú‚îÄ‚îÄ wl_vehicle_speed/
‚î?   ‚î?   ‚îú‚îÄ‚îÄ include/
‚î?   ‚î?   ‚î?   ‚îú‚îÄ‚îÄ wl_vehicle_speed.h
‚î?   ‚î?   ‚î?   ‚îî‚îÄ‚îÄ wlVehicleSpeed.h
‚î?   ‚î?   ‚îî‚îÄ‚îÄ src/
‚î?   ‚î?       ‚îú‚îÄ‚îÄ wl_vehicle_speed.cc
‚î?   ‚î?       ‚îî‚îÄ‚îÄ wlVehicleSpeed.cc
‚î?   ‚îú‚îÄ‚îÄ 
‚î?
‚îú‚îÄ‚îÄ signals/
‚î?   ‚îî‚îÄ‚îÄ signal.h
‚î?
‚îú‚îÄ‚îÄ utility/
‚î?   ‚îú‚îÄ‚îÄ hysteresis.h
‚î?   ‚îî‚îÄ‚îÄ increment_timer.h
‚î?
‚îú‚îÄ‚îÄ tests/
‚î?   ‚îú‚îÄ‚îÄ module/
‚î?   ‚î?   ‚îú‚îÄ‚îÄ gear_display_facade/
‚î?   ‚î?   ‚î?   ‚îú‚îÄ‚îÄ CMakeLists.txt
‚î?   ‚î?   ‚î?   ‚îî‚îÄ‚îÄ main.cpp
‚î?   ‚î?   ‚îú‚îÄ‚îÄ hydraulic_oil_warning/
‚î?   ‚î?   ‚î?   ‚îú‚îÄ‚îÄ CMakeLists.txt
‚î?   ‚î?   ‚î?   ‚îî‚îÄ‚îÄ main.cpp
‚î?   ‚î?   ‚îú‚îÄ‚îÄ instantiation_practice/
‚î?   ‚î?   ‚î?   ‚îú‚îÄ‚îÄ CMakeLists.txt
‚î?   ‚î?   ‚î?   ‚îî‚îÄ‚îÄ main.cpp
‚î?   ‚î?   ‚îú‚îÄ‚îÄ wl_cooling_fan_control/
‚î?   ‚î?   ‚î?   ‚îú‚îÄ‚îÄ CMakeLists.txt
‚î?   ‚î?   ‚î?   ‚îî‚îÄ‚îÄ main.cpp
‚î?   ‚î?   ‚îî‚îÄ‚îÄ wl_vehicle_speed/
‚î?   ‚î?   ‚î?   ‚îú‚îÄ‚îÄ CMakeLists.txt
‚î?   ‚î?   ‚î?   ‚îî‚îÄ‚îÄ main.cpp
‚î?   ‚îî‚îÄ‚îÄ unit/
‚î?       ‚îú‚îÄ‚îÄ CMakeLists.txt
‚î?       ‚îî‚îÄ‚îÄ test_hysteresis.cpp
‚î?
‚îú‚îÄ‚îÄ Arduino_project/
‚î?   ‚îî‚îÄ‚îÄ OilTempWarningDemo/
‚î?       ‚îú‚îÄ‚îÄ OilTempWarningDemo.ino
‚î?       ‚îú‚îÄ‚îÄ version management/
‚î?       ‚î?   ‚îú‚îÄ‚îÄ 1/
‚î?       ‚î?   ‚î?   ‚îî‚îÄ‚îÄ OilTempWarningDemo.ino
‚î?       ‚î?   ‚îú‚îÄ‚îÄ 2/
‚î?       ‚î?   ‚î?   ‚îî‚îÄ‚îÄ OilTempWarningDemo.ino
‚î?       ‚î?   ‚îú‚îÄ‚îÄ 3/
‚î?       ‚î?   ‚î?   ‚îî‚îÄ‚îÄ OilTempWarningDemo.ino
‚î?       ‚î?
‚î?       ‚îî‚îÄ‚îÄ src/
‚î?           ‚îú‚îÄ‚îÄ framework/
‚î?           ‚î?   ‚îú‚îÄ‚îÄ manager.h
‚î?           ‚î?   ‚îî‚îÄ‚îÄ module_interface.h
‚î?           ‚îú‚îÄ‚îÄ modules/
‚î?           ‚î?   ‚îú‚îÄ‚îÄ oil_temp_warning.h
‚î?           ‚î?   ‚îú‚îÄ‚îÄ oil_temp_warning.cpp
‚î?	        ‚î?   ‚îú‚îÄ‚îÄ  fan_cooling_control.h
‚î?	        ‚î?   ‚îú‚îÄ‚îÄ  fan_cooling_control.cpp
‚î?	        ‚î?
‚î?           ‚îú‚îÄ‚îÄ signals/
‚î?           ‚î?   ‚îî‚îÄ‚îÄ signal.h
‚î?           ‚îî‚îÄ‚îÄ utility/
‚î?               ‚îú‚îÄ‚îÄ hysteresis.h
‚î?                ‚îî‚îÄ‚îÄ increment_timer.h
‚îî‚îÄ‚îÄ README.md
...
Å® Symptoms, causes, diagnosis, and solutions

## Circuitnotes

See [Troubleshooting Notes](docs/CIRCUIT_NOTES.md).
Å® Circuit design, theory, formulas, measurements, and improvements
