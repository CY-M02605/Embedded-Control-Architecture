...
int main() {
    ...
    // Input signals
    signals::SpeedSignal engine_rpm(1500.0f, signals::VALID);
    signals::ShiftSignal gear_ratio(3, signals::VALID);

    // Create adapter module
    wl_vehicle_speed::WlVehicleSpeed speed_module(engine_rpm, gear_ratio, manager);
    speed_module.Init();
